      ...
      <div className="p-4 md:p-8 rounded bg-[#25252d] w-full max-h-[85%] overflow-hidden flex flex-col">
        ...
        <ul>
          ...
          <li className="text-l">
            👇
            <span className="ml-2">
              Try embedding a PDF below, then asking questions! You can even turn off your WiFi. <a href="biomimetics-07-00103.pdf" download className="text-blue-500 hover:underline ml-2">
